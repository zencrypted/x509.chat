...
This work compares five representative secure messaging protocols with respect
...
High software speed, mandatory in TLS 1.3. ChaCha20-Poly1305 is used in Chat X.509 v2.
...
Double Ratchet (2-Ratched) is used in Signal, WhatsApp, Viber.
...
Identity / Long-term     & X.509 cert SECP256v1 key       & X.509 cert X25519 key\\
