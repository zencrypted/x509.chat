...
This work compares six representative secure messaging protocols with respect
...
The comparison is structured around a set of core cryptographic parameters,
...
All examined protocols use elliptic-curve-based Diffie--Hellman variants.
...
side-channel resistance and transparent parameters. Curve25519 / X25519 is
used in Threema, Signal, WhatsApp, Session, Chat X.509 v2, Viber.
...
post-compromise security. X3DH is used in Signal, WhatsApp, Viber, Chat X.509 v2.
...
GCM tag is used in Signal, WhatsApp, Viber.
...
AES-256-GCM AE is used in Signal, WhatsApp, Viber.
...
Double Ratchet (2-Ratchet) is used in Signal, WhatsApp, Viber.
...
ratchet is used in Threema, Session.
...
Identity / Long-term     & Server-mediated (long-term)    & X25519 ket pair\\
Key Derivation           & Custom (SHA-256 based)         & HKDF (SHA-256/512) \\
Symmetric Encryption     & AES-256-IGE                    & XSalsa20 \\
Authentication / MAC     & Custom SHA-256 msg\_key        & HMAC-SHA256 \\
Authenticated Encryption & Custom (IGE + MAC)             & XSalsa20+HMAC-SHA256 \\
Forward Secrecy          & Yes (100msgs/1week)            & Yes (2-Ratchet) \\
Post-Compromise Security & No                             & Yes (2-Ratchet) \\
Standards / Format       & MTProto 2.0 custom             & 160-bit \\ \hline
\end{tabular}
\end{center}
...
All five protocols currently offer low quantum resistance due to their
